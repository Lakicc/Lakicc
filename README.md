...
# Hristijan Rafajlovski

**Software Engineer** &nbsp;·&nbsp; `@Lakicc`

Building fast, accessible web products, from design system to production deploy.
...
[![CV](https://img.shields.io/badge/CV-B30B00?style=for-the-badge&logo=data:image/svg%2Bxml;base64,)](https://hristijanrafajlovski.com/assets/cv.pdf)
...
I build web products end to end, interface, front-end architecture, performance, accessibility, and the deployment pipeline behind them. I care about the things users actually feel: how fast a page paints, whether it works on a bad connection, and whether everyone can use it.

Most of my work is React and TypeScript. I also write Lua and C++, which is where I first learned to care about how software performs.

> **Currently open to full-time engineering roles and select freelance projects.**
...
&nbsp;&nbsp;**[Live site](https://noexdev.com)**&nbsp; · &nbsp;**[Case study](https://github.com/Lakicc/noexdev)**
...
💼 &nbsp; [LinkedIn](https://www.linkedin.com/in/hristijan-rafajlovski)
...
<div align="center">
<br>
<sub>Based in Tetovo, North Macedonia · Working remotely across Europe and USA</sub>
</div>
